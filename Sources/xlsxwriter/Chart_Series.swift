...
public struct Chart {
  ...
  @discardableResult
  public func addSeries(values: String? = nil, name: String? = nil) -> Series {
    let series: Series
    if let values = values {
      series = values.withCString {
  ...
  @discardableResult
  public func set(x_axis name: String) -> Chart {
    name.withCString {
  ...
  @discardableResult
  public func set(y_axis name: String) -> Chart {
    name.withCString {
  ...
  @discardableResult
  public func title(name: String) -> Chart {
    name.withCString {
      chart_title_set_name(lxw_chart, $0)
    }
  ...
  /// Turn off/hide axis.
  @discardableResult
  public func axis_off(_ axis: Axes) -> Chart {
    switch axis {
  ...
  @discardableResult
  public func major_gridlines(_ axis: Axes, visible: Bool = true) -> Chart {
  ...
  @discardableResult
  public func minor_gridlines(_ axis: Axes, visible: Bool = true) -> Chart {
    let visible = UInt8(visible ? 1 : 0)
    switch axis {
  ...
  @discardableResult
  public func title_off() -> Chart {
    chart_title_off(lxw_chart)
    return self
  }
  /// Set the position of the chart legend.
  @discardableResult
  public func legend(position: Legend_position) -> Chart {
...
public struct Series {
  ...
  @discardableResult
  public func set(name: String) -> Series {
    let _ = name.withCString {
  ...
  @discardableResult
  public func values(sheet: Worksheet, range: Range) -> Series {
  ...
  @discardableResult
  public func categories(sheet: Worksheet, range: Range) -> Series {
    let _ = sheet.name.withCString {
  ...
  @discardableResult
  public func set(smooth: Bool) -> Series {
  ...
  @discardableResult
  public func name(sheet: Worksheet, cell: Cell) -> Series {
    let _ = sheet.name.withCString {
  ...
  @discardableResult
  public func trendline(type: Trendline_type, value: Int = 2) -> Series {
    chart_series_set_trendline(lxw_chart_series, type.rawValue, UInt8(value))
    return self
  }
  /// Set the trendline name for a chart data series.
  @discardableResult
  public func trendline(name: String) -> Series {
    let _ = name.withCString {
      chart_series_set_trendline_name(lxw_chart_series, $0)
    }
    return self
  }
  /// Set the trendline line properties for a chart data series.
  @discardableResult
  public func trendline(
    color: Color = .black, width: Float = 2.25, dash_type: Int,
    transparency: Int = 0, hide: Bool = false
  ) -> Series {
    var line = lxw_chart_line(
      color: Color.black.rawValue,
      none: (hide ? 1 : 0),
      width: width,
      dash_type: UInt8(dash_type),
